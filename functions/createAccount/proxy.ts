// proxy.ts — Deno Deploy production-ready
import { serve } from "https://deno.land/std@0.177.0/http/server.ts";
import { createClient } from "https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm";

// Environment variables from Deno Deploy
const SUPABASE_URL = Deno.env.get("PROJECT_URL")!;
const SERVICE_ROLE_KEY = Deno.env.get("SERVICE_KEY")!;

if (!SUPABASE_URL || !SERVICE_ROLE_KEY) {
  console.error("❌ Environment variables PROJECT_URL or SERVICE_KEY are missing!");
  throw new Error("Missing environment variables.");
}

const supabase = createClient(SUPABASE_URL, SERVICE_ROLE_KEY);

// Whitelist your GitHub Pages domain for CORS
const ALLOWED_ORIGIN = "https://www.theoaklinebank.com";
